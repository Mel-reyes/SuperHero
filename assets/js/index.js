$(document).ready(function () {
    $(".classForm").on("submit", function (e) {
        ...
        if (isNaN(superHeroID) || superHeroID < 1 || superHeroID > 731) {
            return alert("Por favor, ingresa un número válido entre 1 y 731.");
        }
            ...
            success: function (dataAPI) {
                const cardHtml = `
                    ...
                    <div class="card mb-3">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="${dataAPI.image.url}" class="img-fluid img-thumbnail h-100 w-100 rounded-start" alt="SuperHero ${dataAPI.name}">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item"><em>Ocupación</em>: ${dataAPI.work.occupation}</li>
                                        <li class="list-group-item"><em>Primera Aparición</em>: ${dataAPI.biography["first-appearance"]}</li>
    ...
    function canvasJSSuperHeroChart(dataAPICanvas) {
        var options = {
            title: {
                text: `Estadísticas de poder de ${dataAPICanvas.name}`,
            },
            data: [
                {
                    type: "pie",
